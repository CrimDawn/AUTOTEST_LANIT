...
public class SkipStepDownAction extends FieldAction {

    private static Logger log = Logger.getLogger(SkipStepDownAction.class);

    /**
     * Basic step information about skip step down
     ...
     */
    public SkipStepDownAction(String fieldType, String fieldIdentification, String fieldIdentificationValue, String fieldValue, String fieldAutoValue, String fieldReadOnly, String fieldFormatFile, String fieldValidation) {
    ...
    public void run(WebDriver driver) {
        ...
        try {
            if (this.fieldIdentification.equals("") &&
                ...
                log.info("Пропущен один шаг назад");
            } else {
