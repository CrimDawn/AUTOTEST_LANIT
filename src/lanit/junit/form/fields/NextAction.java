...
public class NextAction extends FieldAction {

    private static Logger log = Logger.getLogger(NextAction.class);

    /**
     * Basic step information about next button
     ...
     */
    public NextAction(String fieldType, String fieldIdentification, String fieldIdentificationValue, String fieldValue, String fieldAutoValue, String fieldReadOnly, String fieldFormatFile, String fieldValidation) {
    ...
    public void run(WebDriver driver) {
        ...
        try {
            if (this.fieldIdentification.equals("") &&
                ...
                boolean existButton = driver.findElements(By.xpath("//span[@id='submitBtn' and contains(., 'Далее')]")).size() > 0;
                String actualValue = "Кнопка 'Далее' существует: " + existButton;
                driver.findElement(By.id("submitBtn")).click();
                new MandatoryFieldValidation().postCheck(driver);
                assertEquals("Кнопка 'Далее' существует: true", actualValue);
            } else {
