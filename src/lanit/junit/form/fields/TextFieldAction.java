...
import lanit.junit.form.fields.validation.TextFieldValidation;
import lanit.junit.selenium.SeleniumPrerequisites;
import org.apache.log4j.Logger;
import org.openqa.selenium.*;

public class TextFieldAction extends FieldAction {

    private static Logger log = Logger.getLogger(TextFieldAction.class);

    /**
     * Basic step information about text field
     ...
     */
    public TextFieldAction(String fieldType, String fieldIdentification, String fieldIdentificationValue, String fieldValue, String fieldAutoValue, String fieldReadOnly, String fieldFormatFile, String fieldValidation) {
        ...
        try {
            if (this.fieldIdentification.equals("id") &&
                ...
                if (this.fieldValidation.equals("Да")) {
                    new TextFieldValidation().check(driver, this.fieldIdentificationValue);
                }
